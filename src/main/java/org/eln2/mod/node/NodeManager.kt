...
import org.eln2.mod.node.transparent.TransparentNode
import org.eln2.mod.node.transparent.TransparentNodeElement
...
class NodeManager(par1Str: String?) : WorldSavedData(par1Str) {
    ...
    override fun writeToNBT(nbt: NBTTagCompound): NBTTagCompound { return nbt }
