...
open class TransparentNodeEntity : NodeBlockEntity() { //, ISidedInventory { TODO add inventory code back
...
*/
    ...
    override val nodeUuid: String
        get() = "TransparentNode" //Eln.transparentNodeBlock.nodeUuid TODO
