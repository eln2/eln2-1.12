...
/*
    ...
    constructor(pos: BlockPos, world: World) {
        this.x = pos.x
        this.y = pos.y
        this.z = pos.z
    ...
    var block: Block
        get() = world().getBlockState(BlockPos(x, y, z)).block//.getBlock(x, y, z)
        set(b) {
            world().setBlockState(BlockPos(x, y, z), b.defaultState)//.setBlock(x, y, z, b)
        }
    ...
    val blockExist: Boolean
        get() {
            ...
            return w.getBlockState(BlockPos(x, y, z)).material != Material.AIR //w.blockExists(x, y, z)
        }
    ...
    val tileEntity: TileEntity?
        get() = world().getTileEntity(BlockPos(x, y, z))
    ...
    fun setWorld(worldObj: World) {
        ...
        dimension = worldObj.provider.dimension
    }
