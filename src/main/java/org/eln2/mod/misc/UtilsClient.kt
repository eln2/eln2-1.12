...
object UtilsClient {
    ...
    fun drawHaloNoLightSetup(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, w: World, x: Int, y: Int, z: Int, bilinear: Boolean) {
        if (halo == null) return
    ...
    @JvmStatic
    fun drawHalo(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, w: World, x: Int, y: Int, z: Int, bilinear: Boolean) {
        disableLight()
        enableBlend()
    ...
    @JvmStatic
    fun drawHaloNoLightSetup(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, e: TileEntity, bilinear: Boolean) {
        drawHaloNoLightSetup(halo, r, g, b, e.world, e.pos.x, e.pos.y, e.pos.z, bilinear)
    }

    @JvmStatic
    fun drawHalo(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, e: TileEntity, bilinear: Boolean) {
        drawHalo(halo, r, g, b, e.world, e.pos.x, e.pos.y, e.pos.z, bilinear)
    }

    @JvmStatic
    fun drawHaloNoLightSetup(halo: Obj3D.Obj3DPart?, distance: Float) {
        if (halo == null) return
    ...
    @JvmStatic
    fun drawHalo(halo: Obj3D.Obj3DPart?, distance: Float) {
        disableLight()
        enableBlend()
    ...
    @JvmStatic
    fun drawHaloNoLightSetup(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, e: Entity, bilinear: Boolean) {
        if (halo == null) return
        if (bilinear) enableBilinear()
        val light = getLight(e.world, floor(e.posX).toInt(), floor(e.posY).toInt(), floor(e.posZ).toInt())
        GL11.glColor4f(r, g, b, 1f - light / 15f)
        halo.draw()
        GL11.glColor4f(1f, 1f, 1f, 1f)
        if (bilinear) disableBilinear()
    ...
    @JvmStatic
    fun drawHalo(halo: Obj3D.Obj3DPart?, r: Float, g: Float, b: Float, e: Entity, bilinear: Boolean) {
        disableLight()
        enableBlend()
...
*/
    ...
    @JvmStatic
    fun drawLight(part: Obj3D.Obj3DPart?) {
        if (part == null) return
        disableLight()
        enableBlend()
        part.draw()
    ...
    @JvmStatic
    fun drawLightNoBind(part: Obj3D.Obj3DPart?) {
        if (part == null) return
        disableLight()
        enableBlend()
        part.drawNoBind()
    ...
    fun drawLight(part: Obj3D.Obj3DPart?, angle: Float, x: Float, y: Float, z: Float) {
        if (part == null) return
        disableLight()
        enableBlend()
...
/*
    ...
    fun getLight(w: World, x: Int, y: Int, z: Int): Int {
        val b = w.getLightFor(EnumSkyBlock.BLOCK, BlockPos(x, y, z))
        val s = w.getLightFor(EnumSkyBlock.SKY, BlockPos(x, y, z)) - w.calculateSkylightSubtracted(0f)
...
/*
    ...
    fun showItemTooltip(src: List<String>, dst: MutableList<String>) {
        ...
        if (showItemTooltip()) {
            ...
            dst.add("\u00a7F\u00a7o<" + "Hold Shift >") //I18N.tr("Hold shift") + ">") TODO: Fix this
        }
    }
